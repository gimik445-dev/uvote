...
// its hash, require it be unused and unexpired, mark it used, then treat a
// successful click as both "email confirmed" and "log me in" — one link,
// one step, no separate password re-entry right after they just set one.
